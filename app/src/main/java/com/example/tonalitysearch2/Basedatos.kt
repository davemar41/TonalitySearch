...
class Basedatos : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(bind3.root)
            ...
            //var tabla2=ArrayList<tabla2>()
            //var tabla3=ArrayList<tabla3>()
        //var registrotabla1=ArrayList<>()
        var registrotabla2:Int
        var registrotabla3:Int

            if(bind3.tabla1.isChecked){


            val builder2= AlertDialog.Builder(this)
            builder2.setTitle("Atencion Musicos")
            ...
            builder2.show()
                ...
                bind3.borrar.setOnClickListener {
                    ...
                    bind3.listacompleta.setOnClickListener {
                        val admin = Cancionyacordes(this,"Canciones", null, 1)
                        if(bind3.tabla1.isChecked){
                            val bd = admin.writableDatabase
                            val fila = bd.rawQuery("select * from tabla1 ", null)
